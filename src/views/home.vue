<template>
  <div style="height: 100%">
    <div class="header">
      <div class="selectRange" style="width: 240px">
        <Menu mode="horizontal" @on-select="selectMenu">
          <MenuItem name="sjfxbb"> 数据分析报表 </MenuItem>
          <MenuItem name="mxyj"> 模型预警 </MenuItem>
        </Menu>
      </div>
      <div class="header-title">漳州市反恐怖情报信息实战平台</div>
      ...
      <!-- <Input style="width: 250px" class="yjSearch" search enter-button placeholder="请输入身份证号查询" /> -->
    </div>
...
export default {
  ...
  methods: {
    selectMenu(e) {
      if (e === 'sjfxbb') {
        window.open('http://172.27.2.28:9223');
      } else if (e === 'mxyj') {
        window.open('http://172.27.2.28:9210');
      }
    },
    pickStartDate(date) {
      // 选择开始时间的回调
...
.header {
  ...
  &-title {
    ...
    font-weight: 600;
    line-height: 2;
    color: rgb(178, 232, 255);
    font-family: '思源黑体 CN Bold Oblique', '思源黑体 CN Bold', '思源黑体 CN', sans-serif;
    // background-image: -webkit-linear-gradient(bottom, rgb(178, 232, 255), rgb(178, 232, 255), rgb(255, 255, 255));
