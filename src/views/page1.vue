...
<script>
const lrlctj = () => import('./bigScreen/components/lrlctj');
const chart2 = () => import('./bigScreen/components/chart2');
const chart4 = () => import('./bigScreen/components/chart4');
const chart3 = () => import('./bigScreen/components/chart3');
const chart5 = () => import('./bigScreen/components/chart5');
const chart6 = () => import('./bigScreen/components/chart6');
// const chart7 = () => import('./bigScreen/components/chart7');
const chart8 = () => import('./bigScreen/components/chart8');
const chart9 = () => import('./bigScreen/components/chart9');
const areaChart = () => import('./bigScreen/components/areaChart');
const pie = () => import('./bigScreen/components/pie');
// const worldMap = () => import('./bigScreen/components/worldMap');
const center = () => import('./bigScreen/components/center');
